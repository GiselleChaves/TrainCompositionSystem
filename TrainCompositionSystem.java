...
>>>>>>> main
        ...
        Carriage car1 = new Carriage(1, 50);
        Carriage car2 = new Carriage(2, 150);
        Carriage car3 = new Carriage(3, 350);
...
=======
        ...
        new RunCode().trainCompositionSystem(); //INSTANCIANDO SEM CRIAR VARIAVEL
